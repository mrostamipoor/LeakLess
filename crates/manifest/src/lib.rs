...
impl TryFrom<ApplicationTriggerSerialised> for ApplicationTrigger {
    ...
    fn try_from(value: ApplicationTriggerSerialised) -> Result<Self, Self::Error> {
        //println!("ApplicationTrigger function here in TryFrom");
        match value {
...
impl From<ApplicationTrigger> for ApplicationTriggerSerialised {
    fn from(value: ApplicationTrigger) -> Self {
        //println!("ApplicationTrigger from function");
        match value {
...
impl TryFrom<ApplicationTrigger> for RedisTriggerConfiguration {
    ...
    fn try_from(trigger: ApplicationTrigger) -> Result<Self, Self::Error> {
        //println!("ApplicationTrigger try function");
        match trigger {
...
impl Debug for ModuleSource {
    fn fmt(&self, f: &mut Formatter) -> Result<(), std::fmt::Error> {
        //println!("ApplicationTrigger fmt function");
        match self {
...
impl TryFrom<TriggerConfig> for HttpConfig {
    ...
    fn try_from(trigger: TriggerConfig) -> Result<Self, Self::Error> {
        //println!("ApplicationTrigger function 1");
        match trigger {
...
impl TryFrom<TriggerConfig> for RedisConfig {
    ...
    fn try_from(trigger: TriggerConfig) -> Result<Self, Self::Error> {
        //println!("ApplicationTrigger function 21");
        match trigger {
