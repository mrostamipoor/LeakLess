...
use annotation_lib::leakless_secret;
...
#[leakless_secret]
const AUTH_TOKEN: &str = "secret_ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
fn is_api_key_valid(api_key: &str) -> bool {
    ...
    //println!("AUTH_TOKEN in lib: {:?}", AUTH_TOKEN);
    //println!("api_key in lib: {:?}", api_key);
    api_key == AUTH_TOKEN
}
